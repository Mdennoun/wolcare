          ...
          SliverAppBar(
              ...
              flexibleSpace: Column(
                children: <Widget>[
                  ...
                  TextField(controller: TextEditingController(text: firstName)),
                  Text(
                    "Nom  : ",
                    style: new TextStyle(fontSize: 17, color: Colors.black),
                  ),
                  TextField(controller: TextEditingController(text: lastName)),
                  Text(
                    "Pseudo  : ",
                    style: new TextStyle(fontSize: 17, color: Colors.black),
                  ),
                  TextField(controller: TextEditingController(text: pseudo)),
                  RaisedButton(
