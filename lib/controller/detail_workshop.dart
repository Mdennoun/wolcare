...
import 'package:wolcaire/controller/modify_workshop.dart';
            ...
            flexibleSpace: Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Text(
                      "Date de création :  ${dateConverter() ?? 'undefined'}",
                ...
                Padding(
                  padding: const EdgeInsets.all(15.0),
                  child: Text(
                    "pseudo : ${pseudoUser ?? 'Utilisateur inconnu'}",
                    textAlign: TextAlign.left,
                    style: new TextStyle(fontSize: 17, color: Colors.black),
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.all(15.0),
                  child: Text(
                    "Heure début : ${dateAvailable ?? 'Heure de début non renseignée'}",
                    textAlign: TextAlign.left,
                    style: new TextStyle(fontSize: 17, color: Colors.black),
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.all(15.0),
                  child: Text(
                    "Heure de fin: ${datEnd ?? 'Heure de fin non renseignée'}",
                    textAlign: TextAlign.left,
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => ModifyWorkShop(
                                  id: id,
                                  title: title,
