          ...
          SliverAppBar(
            ...
            flexibleSpace: Column(
              ...
              children: <Widget>[
                ...
                TextField(controller: TextEditingController(text: pseudoUser)),
                Text(
                  "Description : ",
                  textAlign: TextAlign.left,
                  style: new TextStyle(fontSize: 17, color: Colors.black),
                ...
                Padding(
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () {
                      ...
                      services.modificationOfWorkShop(
                          titlEdt.text.toString(),
                          descriptionEdt.text.toString(),
                          id,
                          DateTime,
                          DateTime); //TODO remplacer pâr les vrai valur
